...
module.exports = data => {
  ...
  if (data) {
    const time_spent_pairs = [
      { a: 'wrap', b: 'send' },
      { a: 'erc20_transfer', b: 'send' },
      { a: 'send', b: 'confirm' },
      { a: 'confirm', b: 'vote' },
      { a: 'confirm', b: 'command', field: 'confirm_execute' },
      { a: 'confirm', b: 'ibc_send', field: 'confirm_ibc' },
      { a: 'confirm', b: 'axelar_transfer' },
      { a: 'vote', b: 'command', field: 'vote_execute' },
      { a: 'vote', b: 'ibc_send', field: 'vote_ibc' },
      { a: 'vote', b: 'axelar_transfer' },
      { a: 'command', b: 'unwrap', field: 'execute_unwrap' },
      { a: 'send', b: 'command', field: 'total' },
      { a: 'send', b: 'ibc_send', field: 'total' },
      { a: 'send', b: 'axelar_transfer', field: 'total' },
      { a: 'send', b: 'unwrap', field: 'total' },
      { a: 'wrap', b: 'command', field: 'total' },
      { a: 'wrap', b: 'ibc_send', field: 'total' },
      { a: 'wrap', b: 'axelar_transfer', field: 'total' },
      { a: 'erc20_transfer', b: 'command', field: 'total' },
      { a: 'erc20_transfer', b: 'ibc_send', field: 'total' },
      { a: 'erc20_transfer', b: 'axelar_transfer', field: 'total' },
    ];

    const { send } = { ...data };
    const { source_chain, destination_chain } = { ...send };
    ...
    const time_spent = Object.fromEntries(
      time_spent_pairs
        .filter(p => {
          const { a, b } = { ...p };
