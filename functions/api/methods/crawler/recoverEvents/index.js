...
const { getTransaction } = require('../../transfers/utils');
const { getChainData, getContracts, GATEWAY_EVENTS } = require('../../../utils/config');
...
module.exports = async params => {
  ...
  const { txHash, toBlockNumber } = { ...params };
  let { blockNumber, chain } = { ...params };
  // normalize
