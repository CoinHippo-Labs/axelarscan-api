...
-e, --environment     environment [testnet|mainnet|testnet-2] [default: testnet]
...
# set ENV
touch ~/.bash_aliases
echo "export PATH=$PATH:/usr/local/go/bin:~/go/bin:~/.axelar_testnet-2/bin:~/.axelar_testnet/bin:~/.axelar/bin" > ~/.bash_aliases
